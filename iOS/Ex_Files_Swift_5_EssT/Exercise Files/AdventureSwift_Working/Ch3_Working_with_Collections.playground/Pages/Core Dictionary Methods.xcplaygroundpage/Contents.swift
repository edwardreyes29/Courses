...
// playerStats = ["Evasion": 12, "MP": 55] // completely overrides dictionary elements with new ones

// Caching and removing items
//playerStats["Gold"] = nil // Removes gold from dictionary by setting it to nil
...
// ? -> Tells compiler, break return chain if any of the keys do't exist (stop gap??)
// Will get bunch of errors, this subscript might contain a nil value
// Use optional binding (later)
