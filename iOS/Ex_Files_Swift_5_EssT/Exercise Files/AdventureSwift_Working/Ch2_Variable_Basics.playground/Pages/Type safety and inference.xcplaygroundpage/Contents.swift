...
// Type annotation
var characterName: String // Tells compiler that this varaible can only contain String types
characterName = "Jax"

// Type annotation + inference
var maxHealth: Int = 100 // Not necessary


// Multiple variables - type annotation shorthand
var inventoryItems, equipmentSlots, currentGold: Int // Declare all three as Integer
