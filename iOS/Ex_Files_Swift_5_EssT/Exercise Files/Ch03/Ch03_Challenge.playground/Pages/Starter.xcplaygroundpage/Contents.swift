 ...
 */
// 1
var shopItemsArray: [String] = ["Salted Pork", "Litchfield Repeater", "Cheese", "Arrows"]
var shopItemsDictionary: [String: Double] = ["Salted Pork": 1.75, "Litchfield Repeater": 220, "Cheese": 0.75, "Arrows": 2.00]

// 2
shopItemsArray.contains("Apple")

// 3
shopItemsArray.insert("Apple", at: 4)
...
// 6
var fullArmorSet: Set = ["Hat", "Vest", "Shirt", "Coat", "Gun Belt", "Bandolier", "Pants", "Boots", "Bandana"]
var currentArmorSet: Set = ["Hat", "Shirt", "Gun Belt", "Pants", "Boots"]
...
// 8
var armorPieceTuple = (name: "Bandit", cost: 325, canEquip: true)
