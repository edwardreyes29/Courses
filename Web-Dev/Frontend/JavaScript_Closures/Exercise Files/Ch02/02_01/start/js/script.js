...
const listWidget = (function() { // contains an IIFE
  const activities = {
  ...
  return {
    ...
    apiKey : "de36e36780976652d3e84a5502633fce", // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
